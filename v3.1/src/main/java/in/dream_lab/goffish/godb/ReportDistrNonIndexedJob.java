...
import in.dream_lab.goffish.hama.LongMapPartitionNclassGsonReader;
...
public class ReportDistrNonIndexedJob {

	 public static void main(String args[]) throws IOException,InterruptedException, ClassNotFoundException, ParseException
	  {
		  HamaConfiguration conf = new HamaConfiguration();
		  GraphJob job = new GraphJob(conf, pathDistrNonIndexed.class);
		  ...
		  job.setInputReaderClass(LongMapPartitionNclassGsonReader.class);

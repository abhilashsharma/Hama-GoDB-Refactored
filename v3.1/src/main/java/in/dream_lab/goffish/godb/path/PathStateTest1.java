...
import in.dream_lab.goffish.godb.path.DoTest.OutputPathKey;
import in.dream_lab.goffish.godb.path.DoTest.Pair;
import in.dream_lab.goffish.godb.path.DoTest.RecursivePathKey;
import in.dream_lab.goffish.godb.path.DoTest.RecursivePathMaintained;
import in.dream_lab.goffish.godb.path.TraversalStep.TraversalWithState;

public class PathStateTest1 implements Writable {

...
import in.dream_lab.goffish.hama.succinctstructure.SuccinctArraySubgraphByteSplitter;
import in.dream_lab.goffish.hama.succinctstructure.SuccinctArrayVertex;
import in.dream_lab.goffish.hama.succinctstructure.SuccinctArrayVertexByteSplitter;
...
public class pathDistrSuccinctArrayStructureByteSplitter extends
AbstractSubgraphComputation<pathDistrSubgraphSuccinctArrayStructureStateByteSplitter, MapValue, MapValue, Text, LongWritable, LongWritable, LongWritable> 
implements ISubgraphWrapup{
	
	public pathDistrSuccinctArrayStructureByteSplitter(String initMsg) {
		// TODO Auto-generated constructor stub
		Arguments=initMsg;
	}
	
	public static final Log LOG = LogFactory.getLog(pathDistrSuccinctArrayStructureByteSplitter.class);
...
//			System.out.println("SENDING OUTPUT MESSAGE:" + new String(remoteM.toString()));
	...
	public void compute(Iterable<IMessage<LongWritable, Text>> messageList) {
		...
		SuccinctArraySubgraphByteSplitter sg=(SuccinctArraySubgraphByteSplitter)getSubgraph();
...
//					}
			...
			while(!getSubgraph().getSubgraphValue().forwardLocalVertexList.isEmpty()) {
				...
				SuccinctArrayVertexByteSplitter<MapValue,MapValue,LongWritable,LongWritable> currentVertex = new SuccinctArrayVertexByteSplitter(new LongWritable(vertexMessageStep.vertexId),sg.getVertexBufferList(),sg.getEdgeBufferList(),'|');

...
import in.dream_lab.goffish.hama.LongMapPartitionSuccinctReaderByteSplitter;
import in.dream_lab.goffish.hama.NonSplitTextInputFormat;

public class pathDistrSuccinctArrayStructureByteSplitterJob {

	 public static void main(String args[]) throws IOException,InterruptedException, ClassNotFoundException, ParseException
	  {
		  HamaConfiguration conf = new HamaConfiguration();
		  GraphJob job = new GraphJob(conf, pathDistrSuccinctArrayStructureByteSplitter.class);
		  job.setJobName("Path");
		  ...
		  job.setSubgraphValueClass(pathDistrSubgraphSuccinctArrayStructureStateByteSplitter.class);
		  job.setInputFormat(NonSplitTextInputFormat.class);
		  job.setInputReaderClass(LongMapPartitionSuccinctReaderByteSplitter.class);

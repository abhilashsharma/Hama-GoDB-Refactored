...
public class BFSDistrSuccinctImplicit extends
AbstractSubgraphComputation<BFSDistrSuccinctImplicitSubgraphState, MapValue, MapValue, Text, LongWritable, LongWritable, LongWritable> implements ISubgraphWrapup {
	
	 public static final Log LOG = LogFactory.getLog(BFSDistrSuccinctImplicit.class);
	public BFSDistrSuccinctImplicit(String initMsg) {
...
//									LOG.info("Querying end");
					...
					LOG.info("*******Querying done********:"+hitList.length);

...
public class BFSDistrSuccinct extends
AbstractSubgraphComputation<BFSDistrSuccinctSubgraphState, MapValue, MapValue, Text, LongWritable, LongWritable, LongWritable> implements ISubgraphWrapup {
	
	 public static final Log LOG = LogFactory.getLog(BFSDistrSuccinct.class);
	public BFSDistrSuccinct(String initMsg) {
...
//								LOG.info12("REMOTEMODIFIEDMSG:" + _modifiedMsg.toString());

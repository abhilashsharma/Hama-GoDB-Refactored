...
public class pathDistrSuccinctArrayStructureSplitPropertyUndirectedPredicateStats extends
AbstractSubgraphComputation<pathDistrSubgraphSuccinctArrayStructureStateSplitPropertyUndirectedPredicateStats, MapValue, MapValue, Text, LongWritable, LongWritable, LongWritable> 
implements ISubgraphWrapup{
	
	public pathDistrSuccinctArrayStructureSplitPropertyUndirectedPredicateStats(String initMsg) {
		// TODO Auto-generated constructor stub
		Arguments=initMsg;
	}
	
	public static final Log LOG = LogFactory.getLog(pathDistrSuccinctArrayStructureSplitPropertyUndirectedPredicateStats.class);

...
import in.dream_lab.goffish.hama.LongMapPartitionSuccinctReader12In;
import in.dream_lab.goffish.hama.LongMapPartitionSuccinctReaderInEdges;
import in.dream_lab.goffish.hama.NonSplitTextInputFormat;

public class pathDistrSuccinctArrayStructureSplitPropertyUndirectedPredicateStatsJob {

	 public static void main(String args[]) throws IOException,InterruptedException, ClassNotFoundException, ParseException
	  {
		  HamaConfiguration conf = new HamaConfiguration();
		  GraphJob job = new GraphJob(conf, pathDistrSuccinctArrayStructureSplitPropertyUndirectedPredicateStats.class);
		  job.setJobName("Path");
		  ...
		  job.setSubgraphValueClass(pathDistrSubgraphSuccinctArrayStructureStateSplitPropertyUndirectedPredicateStats.class);

...
public class VertexSubgraphMapDistr extends
AbstractSubgraphComputation<LongWritable, MapValue, MapValue, Text, LongWritable, LongWritable, LongWritable> implements ISubgraphWrapup {
	
	 public static final Log LOG = LogFactory.getLog(VertexSubgraphMapDistr.class);
	public VertexSubgraphMapDistr(String initMsg) {

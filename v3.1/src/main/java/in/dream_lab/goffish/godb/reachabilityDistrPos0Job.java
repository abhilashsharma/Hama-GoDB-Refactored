...
public class reachabilityDistrPos0Job {

	 public static void main(String args[]) throws IOException,InterruptedException, ClassNotFoundException, ParseException
	  {
		  HamaConfiguration conf = new HamaConfiguration();
		  GraphJob job = new GraphJob(conf, reachabilityDistrPos0.class);
		  job.setJobName("Reachability StartPos 0");
		  ...
		  job.setSubgraphValueClass(reachabilityDistrPos0SubgraphState.class);

...
public class pathDistrHistJob {

	 public static void main(String args[]) throws IOException,InterruptedException, ClassNotFoundException, ParseException
	  {
		  HamaConfiguration conf = new HamaConfiguration();
		  GraphJob job = new GraphJob(conf, pathDistrHist.class);
		  job.setJobName("Path with histograms");
		  ...
		  job.setSubgraphValueClass(pathDistrHistSubgraphState.class);

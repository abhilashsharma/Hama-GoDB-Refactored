...
import in.dream_lab.goffish.godb.succinct.SuccinctSubgraph;



public class pathDistrSuccinctIndex extends
AbstractSubgraphComputation<pathDistrSuccinctSubgraphState, MapValue, MapValue, Text, LongWritable, LongWritable, LongWritable> 
implements ISubgraphWrapup{
	
	public pathDistrSuccinctIndex(String initMsg) {
		// TODO Auto-generated constructor stub
		Arguments=initMsg;
	}
	
	public static final Log LOG = LogFactory.getLog(pathDistrSuccinctIndex.class);
    ...
    private static List<Long> hitList;    
	static Hueristics hueristics = new Hueristics();
	//Succinct Index objects
	static SuccinctSubgraph succinctSubgraph=null;

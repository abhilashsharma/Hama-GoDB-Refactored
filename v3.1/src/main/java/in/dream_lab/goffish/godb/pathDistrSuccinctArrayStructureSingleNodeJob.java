...
public class pathDistrSuccinctArrayStructureSingleNodeJob {

	 public static void main(String args[]) throws IOException,InterruptedException, ClassNotFoundException, ParseException
	  {
		  HamaConfiguration conf = new HamaConfiguration();
		  GraphJob job = new GraphJob(conf, pathDistrSuccinctArrayStructureSingleNode.class);
		  job.setJobName("Path");
		  ...
		  job.setSubgraphValueClass(pathDistrSubgraphSuccinctArrayStructureSingleNodeState.class);

...
import in.dream_lab.goffish.godb.pathDistrInt.OutputMessageSteps;
import in.dream_lab.goffish.godb.pathDistrInt.OutputPathKey;
import in.dream_lab.goffish.godb.pathDistrInt.Pair;
import in.dream_lab.goffish.godb.pathDistrInt.RecursivePathKey;
import in.dream_lab.goffish.godb.pathDistrInt.RecursivePathMaintained;
import in.dream_lab.goffish.godb.pathDistrInt.VertexMessageSteps;

public class pathDistrIntSubgraphState implements Writable {
	...
	// Variables and DataStructures
		...
		HashMap<Integer,ResultSet> resultsMap = new HashMap<Integer,ResultSet>();
		...
		HashMap<Integer,HashMap<Integer,EdgeAttr>>  InEdges = null;

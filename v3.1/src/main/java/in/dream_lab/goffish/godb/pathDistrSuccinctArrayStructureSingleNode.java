...
public class pathDistrSuccinctArrayStructureSingleNode extends
AbstractSubgraphComputation<pathDistrSubgraphSuccinctArrayStructureSingleNodeState, MapValue, MapValue, Text, LongWritable, LongWritable, LongWritable> 
implements ISubgraphWrapup{
	
	public pathDistrSuccinctArrayStructureSingleNode(String initMsg) {
		// TODO Auto-generated constructor stub
		Arguments=initMsg;
	}
	
	public static final Log LOG = LogFactory.getLog(pathDistrSuccinctArrayStructureSingleNode.class);

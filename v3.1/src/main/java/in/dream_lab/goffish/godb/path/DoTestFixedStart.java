...
public class DoTestFixedStart extends
        AbstractSubgraphComputation<PathStateFixedTest, MapValue, MapValue, PathMessage, LongWritable, LongWritable, LongWritable>
        implements ISubgraphWrapup {

	public static final Log LOG = LogFactory.getLog(DoTestFixedStart.class);
...
//            this.prevPartitionId = _prevPartitionId;
	 ...
	 * @param initMsg
	 */
	public DoTestFixedStart(String initMsg) {
		queryParam=initMsg;
	}
...
//              hueristics=HueristicsLoad.getInstance();//loading this at a different place
	...
	private void doSuperstep0() {
		ISubgraph<PathStateFixedTest, MapValue, MapValue, LongWritable, LongWritable, LongWritable> subgraph = getSubgraph();
		PathStateFixedTest state = subgraph.getSubgraphValue();
...
//                                      startPos=0;//used for debugging
                                      ...
                                      System.out.println("Starting Position:" + state.startPos +"  Query min Cost:" + minCost + "   Path Size:" + state.path.size() + "CurrentQuery:" +currentProperty +","+currentValue.toString()); 

...
public class reachabilityDistrNonIndexedJob {

	 public static void main(String args[]) throws IOException,InterruptedException, ClassNotFoundException, ParseException
	  {
		  HamaConfiguration conf = new HamaConfiguration();
		  GraphJob job = new GraphJob(conf, reachabilityDistrNonIndexed.class);
		  ...
		  job.setSubgraphValueClass(reachabilityDistrNonIndexedSubgraphState.class);

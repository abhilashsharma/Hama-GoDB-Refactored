...
public class pathDistrSuccinctArrayStructureSplitPropertyUndirectedFixed extends
AbstractSubgraphComputation<pathDistrSubgraphSuccinctArrayStructureStateSplitPropertyUndirectedFixed, MapValue, MapValue, Text, LongWritable, LongWritable, LongWritable> 
implements ISubgraphWrapup{
	
	public pathDistrSuccinctArrayStructureSplitPropertyUndirectedFixed(String initMsg) {
		// TODO Auto-generated constructor stub
		Arguments=initMsg;
	}
	
	public static final Log LOG = LogFactory.getLog(pathDistrSuccinctArrayStructureSplitPropertyUndirectedFixed.class);
...
//					computeNWFixedHeu();
					...
					getSubgraph().getSubgraphValue().startPos=fixedPos;

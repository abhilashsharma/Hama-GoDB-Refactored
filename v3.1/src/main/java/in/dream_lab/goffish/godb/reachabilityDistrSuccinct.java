...
public class reachabilityDistrSuccinct extends
AbstractSubgraphComputation<reachabilityDistrSubgraphSuccinctState, MapValue, MapValue, Text, LongWritable, LongWritable, LongWritable>
implements ISubgraphWrapup{


	public reachabilityDistrSuccinct(String initMsg) {
		// TODO Auto-generated constructor stub
		Arguments=initMsg;
	}
	public static final Log LOG = LogFactory.getLog(reachabilityDistrSuccinct.class);
	long time;
...
//						SuccinctArrayVertex12Implicit<MapValue,MapValue,LongWritable,LongWritable> otherVertexObject = new SuccinctArrayVertex12Implicit(new LongWritable(otherVertex),sg.getVertexSuccinctBuffer(),sg.getPropertySuccinctBufferMap(),sg.getEdgeBufferList());
						...
						String prop=otherVertexObject.getPropforVertex(propToIndex.get(getSubgraph().getSubgraphValue().endVertex.property.toString()));
...
//						SuccinctArrayVertex12Implicit<MapValue,MapValue,LongWritable,LongWritable> otherVertex = new SuccinctArrayVertex12Implicit(new LongWritable(otherVertexId),sg.getVertexSuccinctBuffer(),sg.getPropertySuccinctBufferMap(),sg.getEdgeBufferList());
						SuccinctArrayVertex<MapValue,MapValue,LongWritable,LongWritable> otherVertex = new SuccinctArrayVertex(new LongWritable(otherVertexId),sg.getVertexBufferList(),sg.getEdgeBufferList(),'|');
						String prop=otherVertex.getPropforVertex(propToIndex.get(getSubgraph().getSubgraphValue().startVertex.property.toString()));

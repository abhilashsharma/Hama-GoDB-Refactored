...
public class pathDistrSuccinctArrayStructureSplitPropertyUndirectedFixedJob {

	 public static void main(String args[]) throws IOException,InterruptedException, ClassNotFoundException, ParseException
	  {
		  HamaConfiguration conf = new HamaConfiguration();
		  GraphJob job = new GraphJob(conf, pathDistrSuccinctArrayStructureSplitPropertyUndirectedFixed.class);
		  job.setJobName("Path");
		  ...
		  job.setSubgraphValueClass(pathDistrSubgraphSuccinctArrayStructureStateSplitPropertyUndirectedFixed.class);

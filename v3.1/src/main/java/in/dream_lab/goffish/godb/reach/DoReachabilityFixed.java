...
public class DoReachabilityFixed extends
	...
	public static final Log LOG = LogFactory.getLog(DoReachabilityFixed.class);
	 ...
	 * @param initMsg
	 */
	public DoReachabilityFixed(String initMsg) {
		...
		queryParam = tokens[1];
		fixedStartPoint=Integer.parseInt(tokens[1].split(Pattern.quote("//"))[1]);
	}

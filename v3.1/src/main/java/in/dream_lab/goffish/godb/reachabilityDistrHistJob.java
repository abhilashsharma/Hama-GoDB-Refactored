...
public class reachabilityDistrHistJob {

	 public static void main(String args[]) throws IOException,InterruptedException, ClassNotFoundException, ParseException
	  {
		  HamaConfiguration conf = new HamaConfiguration();
		  GraphJob job = new GraphJob(conf, reachabilityDistrHist.class);
		  job.setJobName("Reachability Histogram");
		  ...
		  job.setSubgraphValueClass(reachabilityDistrHistSubgraphState.class);

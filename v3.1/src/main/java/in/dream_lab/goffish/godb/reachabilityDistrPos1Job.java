...
public class reachabilityDistrPos1Job {

	 public static void main(String args[]) throws IOException,InterruptedException, ClassNotFoundException, ParseException
	  {
		  HamaConfiguration conf = new HamaConfiguration();
		  GraphJob job = new GraphJob(conf, reachabilityDistrPos1.class);
		  job.setJobName("Reachability Start Pos 1");
		  ...
		  job.setSubgraphValueClass(reachabilityDistrPos1SubgraphState.class);

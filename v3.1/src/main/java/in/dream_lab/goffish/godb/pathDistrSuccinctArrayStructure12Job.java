...
public class pathDistrSuccinctArrayStructure12Job {

	 public static void main(String args[]) throws IOException,InterruptedException, ClassNotFoundException, ParseException
	  {
		  HamaConfiguration conf = new HamaConfiguration();
		  GraphJob job = new GraphJob(conf, pathDistrSuccinctArrayStructure12.class);
		  job.setJobName("Path");
		  ...
		  job.setSubgraphValueClass(pathDistrSubgraphSuccinctArrayStructureState12.class);

...
public class pathDistrSplitPropertySuccinctArrayStructureSingleNode extends
AbstractSubgraphComputation<pathDistrSubgraphSplitPropertySuccinctArrayStructureSingleNodeState, MapValue, MapValue, Text, LongWritable, LongWritable, LongWritable> 
implements ISubgraphWrapup{
	
	public pathDistrSplitPropertySuccinctArrayStructureSingleNode(String initMsg) {
		// TODO Auto-generated constructor stub
		Arguments=initMsg;
	}
	
	public static final Log LOG = LogFactory.getLog(pathDistrSplitPropertySuccinctArrayStructureSingleNode.class);

...
public class reachabilityDistrPos0 extends
AbstractSubgraphComputation<reachabilityDistrPos0SubgraphState, MapValue, MapValue, Text, LongWritable, LongWritable, LongWritable>
implements ISubgraphWrapup{
	
	
	public reachabilityDistrPos0(String initMsg) {
		// TODO Auto-generated constructor stub
		Arguments=initMsg;
	}
	public static final Log LOG = LogFactory.getLog(reachabilityDistrPos0.class);
	long time;

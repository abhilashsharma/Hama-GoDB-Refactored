...
public class MetisAdjListSuccinct extends
AbstractSubgraphComputation<LongWritable, MapValue, MapValue, Text, LongWritable, LongWritable, LongWritable> implements ISubgraphWrapup {
	 ...
	 public static final Log LOG = LogFactory.getLog(MetisAdjListSuccinct.class);
	public MetisAdjListSuccinct(String initMsg) {

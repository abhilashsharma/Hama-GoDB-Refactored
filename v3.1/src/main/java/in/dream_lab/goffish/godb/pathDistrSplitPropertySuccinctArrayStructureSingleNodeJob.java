...
public class pathDistrSplitPropertySuccinctArrayStructureSingleNodeJob {

	 public static void main(String args[]) throws IOException,InterruptedException, ClassNotFoundException, ParseException
	  {
		  HamaConfiguration conf = new HamaConfiguration();
		  GraphJob job = new GraphJob(conf, pathDistrSplitPropertySuccinctArrayStructureSingleNode.class);
		  job.setJobName("Path");
		  ...
		  job.setSubgraphValueClass(pathDistrSubgraphSplitPropertySuccinctArrayStructureSingleNodeState.class);

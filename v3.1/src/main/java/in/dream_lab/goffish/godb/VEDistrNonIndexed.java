...
public class VEDistrNonIndexed extends
AbstractSubgraphComputation<VEDistrNonIndexedSubgraphState, MapWritable, MapWritable, Text, LongWritable, LongWritable, LongWritable>
implements ISubgraphWrapup{
	
	 public static final Log LOG = LogFactory.getLog(VEDistrNonIndexed.class);
	public VEDistrNonIndexed(String initMsg) {

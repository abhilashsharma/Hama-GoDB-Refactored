...
import in.dream_lab.goffish.godb.reach.succinct.reachabilityDistrSuccinctArray.VertexMessageSteps;

public class reachabilityDistrSuccinctArraySubgraphState implements Writable {
	...
	public  Hueristics hueristics = new Hueristics(); 

...
public class pathDistrSuccinctArrayStructureInUndirected extends
AbstractSubgraphComputation<pathDistrSubgraphSuccinctArrayStructureStateInUndirected, MapValue, MapValue, Text, LongWritable, LongWritable, LongWritable> 
implements ISubgraphWrapup{
	
	public pathDistrSuccinctArrayStructureInUndirected(String initMsg) {

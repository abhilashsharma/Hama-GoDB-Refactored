...
public class reachabilityDistrSuccinctSplitPropertyJob {

	 public static void main(String args[]) throws IOException,InterruptedException, ClassNotFoundException, ParseException
	  {
		  HamaConfiguration conf = new HamaConfiguration();
		  GraphJob job = new GraphJob(conf, reachabilityDistrSuccinctSplitProperty.class);
		  ...
		  job.setSubgraphValueClass(reachabilityDistrSubgraphSuccinctSplitPropertyState.class);

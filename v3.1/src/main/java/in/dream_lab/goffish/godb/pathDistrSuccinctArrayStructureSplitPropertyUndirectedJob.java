...
public class pathDistrSuccinctArrayStructureSplitPropertyUndirectedJob {

	 public static void main(String args[]) throws IOException,InterruptedException, ClassNotFoundException, ParseException
	  {
		  HamaConfiguration conf = new HamaConfiguration();
		  GraphJob job = new GraphJob(conf, pathDistrSuccinctArrayStructureSplitPropertyUndirected.class);
		  job.setJobName("Path");
		  ...
		  job.setSubgraphValueClass(pathDistrSubgraphSuccinctArrayStructureStateSplitPropertyUndirected.class);

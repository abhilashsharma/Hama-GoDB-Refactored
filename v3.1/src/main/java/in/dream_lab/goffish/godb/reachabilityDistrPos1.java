...
public class reachabilityDistrPos1 extends
AbstractSubgraphComputation<reachabilityDistrPos1SubgraphState, MapValue, MapValue, Text, LongWritable, LongWritable, LongWritable>
implements ISubgraphWrapup{
	
	
	public reachabilityDistrPos1(String initMsg) {
		// TODO Auto-generated constructor stub
		Arguments=initMsg;
	}
	public static final Log LOG = LogFactory.getLog(reachabilityDistrPos1.class);
	long time;

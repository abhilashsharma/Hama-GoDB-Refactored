...
public class pathDistrNonIndexed extends
AbstractSubgraphComputation<pathDistrNonIndexedSubgraphState, MapValue, MapValue, Text, LongWritable, LongWritable, LongWritable> 
implements ISubgraphWrapup{
	
	public pathDistrNonIndexed(String initMsg) {
		// TODO Auto-generated constructor stub
		Arguments=initMsg;
	}
	
	public static final Log LOG = LogFactory.getLog(pathDistrNonIndexed.class);

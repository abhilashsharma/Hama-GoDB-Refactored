...
import in.dream_lab.goffish.godb.pathDistrSuccinctHashMapStructure.OutputMessageSteps;
import in.dream_lab.goffish.godb.pathDistrSuccinctHashMapStructure.OutputPathKey;
import in.dream_lab.goffish.godb.pathDistrSuccinctHashMapStructure.Pair;
import in.dream_lab.goffish.godb.pathDistrSuccinctHashMapStructure.RecursivePathKey;
import in.dream_lab.goffish.godb.pathDistrSuccinctHashMapStructure.RecursivePathMaintained;
import in.dream_lab.goffish.godb.pathDistrSuccinctHashMapStructure.VertexMessageSteps;

public class pathDistrSubgraphSuccinctHashMapStructureState implements Writable {
	...
	// Variables and DataStructures
		...
		LinkedList<Tuple<Long,VertexMessageSteps>> forwardRemoteVertexList = new LinkedList<Tuple<Long,VertexMessageSteps>>();
		LinkedList<VertexMessageSteps> revRemoteVertexList = new LinkedList<VertexMessageSteps>();//not used now... remember to change when used
		...
		LinkedList<Tuple<Long,VertexMessageSteps>> forwardLocalVertexList;
		LinkedList<Tuple<Long,VertexMessageSteps>> revLocalVertexList;

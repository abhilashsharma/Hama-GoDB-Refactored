...
public class SuccinctArraySubgraphInEdges<S extends Writable, V extends Writable, E extends Writable, I extends Writable, J extends Writable, K extends Writable> implements ISubgraph<S, V, E, I, J, K> {
  private SuccinctIndexedFileBuffer succinctIndexedVertexFileBuffer,succinctIndexedEdgeFileBuffer;
    ...
    public K subgraphId;
    S _value;
    public static final org.apache.commons.logging.Log Log = LogFactory.getLog(SuccinctArraySubgraphInEdges.class);
...
//    String vertexPath,edgePath;
    public SuccinctArraySubgraphInEdges(K subgraphId, List<SuccinctIndexedFileBuffer> _vertexSuccinctBufferList,List<SuccinctIndexedFileBuffer> _outEdgeSuccinctBufferList,List<SuccinctIndexedFileBuffer> _inEdgeSuccinctBufferList)
    {
//    	vertexPath=vPath;
//    	edgePath=ePath;

...
public class LongMapPartitionSubsetGsonReaderSynthlong<S extends Writable, V extends Writable, E extends Writable, K extends Writable, M extends Writable>
    implements
  ...
  public LongMapPartitionSubsetGsonReaderSynthlong(
      BSPPeer<Writable, Writable, Writable, Writable, Message<K, M>> peer,

...
public class LongRemoteVertex<V extends Writable, E extends Writable, I extends Writable, J extends Writable, K extends Writable>
  ...
  public LongRemoteVertex(long vertexID, long subgraphID) {
    this.vertexID = vertexID;
    this.subgraphID = subgraphID;
  }

  public LongRemoteVertex(long vertexID) {
    this.vertexID = vertexID;
  }
  ...
  public K getSubgraphId() {
    return (K) new LongWritable(subgraphID);
  }

...
public class LongMapPartitionSubsetSuccinctGsonReader<S extends Writable, V extends Writable, E extends Writable, K extends Writable, M extends Writable>
    implements
...
//    this.vertexPropertySet.add("country");
  ...
  public static final Log LOG = LogFactory.getLog(LongMapPartitionSubsetSuccinctGsonReader.class);
...
//    }
    for(ISubgraph<S, V, E, LongWritable, LongWritable, LongWritable> sg:partition.getSubgraphs()) {
    	SuccinctSubgraph<S, V, E, LongWritable, LongWritable, LongWritable> succinctSubgraph=(SuccinctSubgraph<S, V, E, LongWritable, LongWritable, LongWritable>)sg;
    	succinctSubgraph.setMap(remoteVertexToSubgraphMap);
    }

 ...
 */
public class SuccinctArrayVertex12Implicit<V extends Writable, E extends Writable, I extends Writable, J extends Writable> implements IVertex<V, E, I, J> {
//	public static final Log LOG = LogFactory.getLog(SuccinctVertex.class);
	public static final Log LOG = LogFactory.getLog(SuccinctArrayVertex12Implicit.class);
	private I vid;
...
//    private char delim;
    ...
    public SuccinctArrayVertex12Implicit(I vid, SuccinctIndexedFileBuffer _vertexSuccinctBuffer,HashMap<String, SuccinctIndexedFileBuffer> propertySuccinctBufferMap, List<SuccinctIndexedFileBuffer> ebufferList)
    {
        this.vid = vid;
...
//        this.delim = delim;
    ...
    public Tuple<List<Long>, List<Long>> getEdges()
    {
        ...
        int bufferno= (int) (((LongWritable)vid).get()/2000000l);
//        int newbufferno=bufferno<(ebufferList.size()-1)? bufferno:(ebufferList.size()-1);
    	...
    	int recordid = (int) (((LongWritable)vid).get() % 2000000l);

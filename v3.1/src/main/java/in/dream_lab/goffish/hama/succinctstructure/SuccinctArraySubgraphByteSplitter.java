...
public class SuccinctArraySubgraphByteSplitter<S extends Writable, V extends Writable, E extends Writable, I extends Writable, J extends Writable, K extends Writable> implements ISubgraph<S, V, E, I, J, K> {
  private SuccinctIndexedFileBuffer succinctIndexedVertexFileBuffer,succinctIndexedEdgeFileBuffer;
    ...
    public K subgraphId;
    S _value;
    public static final org.apache.commons.logging.Log Log = LogFactory.getLog(SuccinctArraySubgraphByteSplitter.class);
...
//    String vertexPath,edgePath;
    public SuccinctArraySubgraphByteSplitter(K subgraphId, List<SuccinctIndexedFileBuffer> _vertexSuccinctBufferList,List<SuccinctIndexedFileBuffer> _edgeSuccinctBufferList)
    {
//    	vertexPath=vPath;
//    	edgePath=ePath;
    	...
    	for (Integer rid : recordID)
    	 {
    		...
    		startFine = System.nanoTime();
    		record = succinctIndexedVertexFileBuffer.extractBytesUntil(offset, delim);

...
public class LongMapPartitionSubsetGsonReaderSynthLongRemoteLongSingleSubgraph<S extends Writable, V extends Writable, E extends Writable, K extends Writable, M extends Writable>
    implements
  ...
  public LongMapPartitionSubsetGsonReaderSynthLongRemoteLongSingleSubgraph(
      BSPPeer<Writable, Writable, Writable, Writable, Message<K, M>> peer,

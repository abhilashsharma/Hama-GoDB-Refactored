...
public class LongMapPartitionNclassGsonReader<S extends Writable, V extends Writable, E extends Writable, K extends Writable, M extends Writable>
    implements
  ...
  public LongMapPartitionNclassGsonReader(
      BSPPeer<Writable, Writable, Writable, Writable, Message<K, M>> peer,
...
//    this.vertexPropertySet.add("country");
  ...
  public static final Log LOG = LogFactory.getLog(LongMapPartitionNclassGsonReader.class);

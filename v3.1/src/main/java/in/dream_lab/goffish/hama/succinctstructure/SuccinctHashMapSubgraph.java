...
public class SuccinctHashMapSubgraph<S extends Writable, V extends Writable, E extends Writable, I extends Writable, J extends Writable, K extends Writable> implements ISubgraph<S, V, E, I, J, K> {
  private SuccinctIndexedFileBuffer succinctIndexedVertexFileBuffer,succinctIndexedEdgeFileBuffer;
    ...
    Map<Long, SuccinctIndexedFileBuffer> subgraphToVertexSuccinctBuffer;
    Map<Long, SuccinctIndexedFileBuffer> subgraphToEdgeSuccinctBuffer;
//    String vertexPath,edgePath;
    public SuccinctHashMapSubgraph(K subgraphId, Map<Long, SuccinctIndexedFileBuffer> _subgraphToVertexSuccinctBuffer,Map<Long, SuccinctIndexedFileBuffer> _subgraphToEdgeSuccinctBuffer)
    {
//    	vertexPath=vPath;
//    	edgePath=ePath;
    	subgraphToVertexSuccinctBuffer=_subgraphToVertexSuccinctBuffer;
    	subgraphToEdgeSuccinctBuffer=_subgraphToEdgeSuccinctBuffer;
        this.subgraphId = subgraphId;
    }
    
    public SuccinctIndexedFileBuffer getVertexBuffer(Long subgraphID)
    {
        return subgraphToVertexSuccinctBuffer.get(subgraphID);
    }
    public SuccinctIndexedFileBuffer getEdgeBuffer(Long subgraphID)
    {
        return subgraphToEdgeSuccinctBuffer.get(subgraphID);
    }
    ...
    public void setLocalMap(Map<Long, Long> v2s)
    {
        this.localvertexToSubgraph = v2s;
    }
    public Map<Long, Long> getLocalMap()
    {
        return localvertexToSubgraph;
    }
